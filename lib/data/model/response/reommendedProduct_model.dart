class RecommedProductModel {
  bool? success;
  List<ReocommedProducts>? products;
  String? limit;
  String? offset;

  RecommedProductModel({this.success, this.products, this.limit, this.offset});

  RecommedProductModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['products'] != null) {
      products = <ReocommedProducts>[];
      json['products'].forEach((v) {
        products!.add(ReocommedProducts.fromJson(v));
      });
    }
    limit = json['limit'];
    offset = json['offset'];
...
class ReocommedProducts {
 ...
 // int? units;
  ...
  ReocommedProducts.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
