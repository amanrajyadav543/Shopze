class ProductsBySubcategoryModel {
  bool? success;
  List<Product>? subCategoryProduct;
  String? limit;
  String? offset;

  ProductsBySubcategoryModel(
      {this.success, this.subCategoryProduct, this.limit, this.offset});

  ProductsBySubcategoryModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['product'] != null) {
      subCategoryProduct = <Product>[];
      json['product'].forEach((v) {
        subCategoryProduct!.add(new Product.fromJson(v));
      });
    }
    limit = json['limit'];
    offset = json['offset'];
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.subCategoryProduct != null) {
      data['product'] = this.subCategoryProduct!.map((v) => v.toJson()).toList();
    }
