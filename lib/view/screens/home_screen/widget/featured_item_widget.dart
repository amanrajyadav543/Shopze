...
class FeaturedProduct extends StatefulWidget {
  ...
  @override
  State<FeaturedProduct> createState() => _BigItemsWidgetState();
}

class _BigItemsWidgetState extends State<FeaturedProduct> {
  @override
  void initState() {
    super.initState();
  }
  ...
  double calculateDiscountedPrice(
    ...
    return actualPrice - (actualPrice * discountPercentage);
  }
        ...
        children: [
          Stack(
            children: [
              ...
              CustomImage(image: '${widget.image}', height:130 , width: 165,fit: BoxFit.fill,),
              widget.favourite!
                  ? SizedBox()
                  : Positioned(
                bottom: 10,
